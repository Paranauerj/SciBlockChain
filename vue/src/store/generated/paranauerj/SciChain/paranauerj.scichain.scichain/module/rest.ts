...
export type ScichainMsgDeleteArticleResponse = object;

export type ScichainMsgDeleteProfileResponse = object;

export type ScichainMsgUpdateArticleResponse = object;

export type ScichainMsgUpdateProfileResponse = object;
...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  ...
  queryArticleAll = (
    ...
    this.request<ScichainQueryAllArticleResponse, RpcStatus>({
      path: `/paranauerj/scichain/scichain/article`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryArticle = (id: string, params: RequestParams = {}) =>
    this.request<ScichainQueryGetArticleResponse, RpcStatus>({
      path: `/paranauerj/scichain/scichain/article/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
  ...
  queryProfileAll = (
    ...
    this.request<ScichainQueryAllProfileResponse, RpcStatus>({
      path: `/paranauerj/scichain/scichain/profile`,
      method: "GET",
      query: query,
      format: "json",
      ...params,
   ...
   */
  queryProfile = (id: string, params: RequestParams = {}) =>
    this.request<ScichainQueryGetProfileResponse, RpcStatus>({
      path: `/paranauerj/scichain/scichain/profile/${id}`,
      method: "GET",
      format: "json",
      ...params,
    });
