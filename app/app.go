...
import (
	...
	scichainmoduletypes "github.com/paranauerj/SciChain/x/scichain/types"
...
type App struct {
	*baseapp.BaseApp
	...
	ScichainKeeper scichainmodulekeeper.Keeper
...
func New(
	...
	app.ScichainKeeper = *scichainmodulekeeper.NewKeeper(
		appCodec,
	...
	app.mm.SetOrderInitGenesis(
		...
		scichainmoduletypes.ModuleName,
	)
...
func initParamsKeeper(appCodec codec.BinaryMarshaler, legacyAmino *codec.LegacyAmino, key, tkey sdk.StoreKey) paramskeeper.Keeper {
	...
	paramsKeeper.Subspace(scichainmoduletypes.ModuleName)
